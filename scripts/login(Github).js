...
a.innerHTML = `<img src="https://about.codecov.io/wp-content/themes/codecov/assets/logos/ci/github/github-icon.svg" alt="">
Login with Github`;
...
document.getElementById('but-anc').addEventListener("click",function(){
